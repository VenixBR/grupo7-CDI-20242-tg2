...
VALUES 
  ...
  (03, 'Street 3', 'Biblioteca Setorial do Centro de Ciências Rurais', 'BSCR'),
  ...
  (11, 'Street 11', 'Biblioteca Setorial do Centro de Saúde', 'BSCS');
...
VALUES
  ...
  (08, 'Literatura', '2020-07-30', 'Hora da Estrela',  01);
  (09, 'Literatura', '2020-07-30', 'Paixão segundo G.H',  01);
  (10, 'Literatura', '2020-07-30', 'Laços de Família',  01);
  (11, 'Literatura', '2020-07-30', 'Felicidade Clandestina',  01);
